...
== Client ID Enforcement for Service Mesh

The Basic Client ID Enforcement Policy works in the same way as the regular policy, with the following differences:
