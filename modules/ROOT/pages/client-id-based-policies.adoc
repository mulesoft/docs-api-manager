...
image::raml-snippet.png["RAML code snippet showing client ID and client secret configuration"]
...
image::clientiddefault.png["Client ID enforcement policy configuration interface with default settings"]
