...
.. Select the *Validations* checkbox if you want validation to be performed on the  content of incoming requests as described in <<SOAP Proxy Schema Validation>>.
