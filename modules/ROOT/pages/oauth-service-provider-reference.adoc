...
.2+|*Operation* .2+|x |Set to *validate* for xref:3.9@mule-runtime::authorization-grant-types.adoc[authorization grant types] that utilize "three-legged OAuth" (Authorization Code, Implicit, and Resource Owner Password Credentials).
...
* `validate`: for xref:3.9@mule-runtime::authorization-grant-types.adoc[authorization grant types] that utilize "three-legged OAuth" (Authorization Code, Implicit, and Resource Owner Password Credentials)
...
* xref:3.9@mule-runtime::configuring-the-spring-security-manager.adoc[Spring Security documentation]