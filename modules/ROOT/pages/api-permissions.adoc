...
+
image::api-permissions1.png["API version selection page with version designator highlighted"]
+
. On the API version page, click Permissions.
+
image::api-permissions2.png["API version page with Permissions tab and user search interface"]
+
...
+
image::api-permissions3.png["List of users with API ownership permissions and Remove option"]
