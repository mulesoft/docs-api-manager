...
... * If you want to simulate your API specification, select the *Enable Console* box and specify a different path in the *Console Path* field, for example, "/spec/*".  
... In the *Validations* field, select the box if you want to validate inbound requests against a specification. You can optionally specify to use query parameters for strict validations.
