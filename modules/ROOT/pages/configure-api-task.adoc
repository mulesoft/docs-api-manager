...
+
. Browse to the bottom of the page and in *Managing Type*, choose Basic Endpoint or Endpoint with Proxy.
+
. Check the *Mule version* box if you want to manage API in Mule 4 or above.
...
* If you chose *Endpoint With Proxy*, select a proxy deployment target Cloudhub or Hybrid.
+
