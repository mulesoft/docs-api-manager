...
... * If you want to simulate your API specification, select *Enable Console* and specify a different path in *Console Path*, for example, "/spec/*".  
...
... Optionally, in *Response timeout*, specify the time (in seconds), when elapsed, the response must time out.
