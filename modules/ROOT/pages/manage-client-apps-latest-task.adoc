...
After access to an API is approved, a contract is automatically created for the API. You can then manage these contracts from your API under the Client Applications section in API Manager. +
