...
In API Manager, you can grant access to applications that want to consume the APIs you develop in Anypoint Platform by creating instance Contracts. +
...
This tab displays information about every contract with your API instance, and a client application.
