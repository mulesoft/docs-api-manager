...
After the user xref:exchange::to-request-access.adoc[requests access] to your API instance from Exchange, you can approve or reject a request from API Manager.
...
+
The request appears, as displayed in the following screenshot:
+
