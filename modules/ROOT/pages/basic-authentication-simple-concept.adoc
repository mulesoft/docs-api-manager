...
The policy returns an "WWW-Authenticate" HTTP header field using the following format:`WWW-Authenticate: Basic realm="mule-realm"`.
|===
...
The `username:password` value must be a base64-encoded string. 
