...
Claim validations enables you to choose the conditions under which a token received in the policy is rejected. The following registered claim validations are provided by default:
