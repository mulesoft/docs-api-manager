...
API Manager gathers analytics data for each API that you manage.  You can generate this data in reports and charts, using the Mule API Analytics Event API. You can create reports for a specific environment or for multiple APIs, and you can create different reports for the same API.
