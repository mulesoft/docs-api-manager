...
*Required:* yes +
*Example:* `format=csv`
|maxResults |Maximum number of events to return. Default value is `20000`, which is also the maximum one. +
