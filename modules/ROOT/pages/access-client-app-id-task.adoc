...
+
As an Application Owner, if you do not have access to API Manager, you can view the xref:exchange::about-my-applications[application credentials] in Exchange.
