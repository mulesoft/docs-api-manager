...
As the owner of a xref:exchange::to-request-access.adoc[registered client application], you are occasionally required to provide your client ID and client secret (optional) when accessing an API, after a contract is created between your application and an API. 
