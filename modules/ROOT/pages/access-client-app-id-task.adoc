...
As an owner of a xref:exchange::to-request-access.adoc[registered client application], you are sometimes required to provide the client ID and the client secret of the application when accessing an API. 
