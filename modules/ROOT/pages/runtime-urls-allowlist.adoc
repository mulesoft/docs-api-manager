...
You might need to add the Anypoint Platform hostnames and ports to an allowlist in your network so that the API Gateway capabilities of the runtime can communicate with the online Anypoint Platform APIs and services that are managed by MuleSoft.
