...
Automated Policies are applied across all APIs. You can apply any Default or a Custom policy to all the APIs in your environment. However, you require specific roles and permissions to apply Automated policies.

// what specific roles and permissions ae needed. Ask Fede? Add a link to the roles and permissions documentation.
