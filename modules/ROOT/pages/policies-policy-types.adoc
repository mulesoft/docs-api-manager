...
// what specific roles and permissions are needed. Ask Fede? Add a link to the roles and permissions documentation.--Ask Tobias Lichtig, Sergio Behrends or Tomás Bruno.
