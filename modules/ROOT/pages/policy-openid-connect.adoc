...
You can enable the OpenID Connect Access Token Enforcement policy to use the gateway proxy settings by specifying the following property when starting Mule runtime engine: 
