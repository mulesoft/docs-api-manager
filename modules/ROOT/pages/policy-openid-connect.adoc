...
This policy is available only to an organization that is configured to use the xref:access-management::configure-client-management-openid-task.adoc[policy as a client-management solution]. 
