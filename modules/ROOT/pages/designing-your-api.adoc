...
image::designing-your-api-c9fdd.png["API Designer interface with three panels: Files, RAML editor, and API Console"]
...
image::designing-your-api-d8129.png["New File dialog with options for selecting RAML spec version and content type"]
...
image::designing-your-api-e62b3.png["View menu with options to toggle API Designer background color"]

=== Getting Help

From the Help menu, you can go to API Designer documentation or report a bug.

image::designing-your-api-dff70.png["Help menu with links to API Designer documentation and bug reporting"]
...
image::designing-your-api-53d84.png["Context menu for file operations showing Save, Rename, and Delete options"]
...
image::designing-your-api-d8c97.png["RAML editor shelf with categories for Root, Docs, Parameters, Security, Resources, Traits and Types, Schemas, and Others"]
...
image::designing-your-api-e1bdc.png["API version details page with Policies section and RAML snippet links"]
