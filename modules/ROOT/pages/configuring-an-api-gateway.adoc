...
Mule 3.8.0 runtime unifies the API Gateway runtime with the core Mule runtime, eliminating the need to configure API Gateway. This document pertains to earlier installations, not to Mule 3.8 runtime deployments managed by xref:runtime-manager::index.adoc[Runtime Manager]. To configure Mule 3.8 runtime, see xref:3.9@mule-runtime::downloading-and-starting-mule-esb.adoc[Downloading and Starting Mule] and xref:3.9@mule-runtime::installing-an-enterprise-license.adoc[Installing an Enterprise License].
