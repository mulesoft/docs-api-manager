...
These installations are configured versions of Mule runtimes and can communicate with Anypoint Platform, including support for link:/api-manager/api-auto-discovery[API Autodiscovery].
...
* Enable link:/api-manager/api-auto-discovery[Autodiscovery].
