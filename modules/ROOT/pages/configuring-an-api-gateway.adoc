...
Before you configure your production gateway, you may want to configure Anypoint Studio to work with your Anypoint Platform organization for testing. First, xref:6.5@studio::install-studio-gw.adoc[download and install API Gateway Runtime] from the Studio Update Site.
