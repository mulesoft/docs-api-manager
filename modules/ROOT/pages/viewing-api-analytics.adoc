...
For more information about how you can view your data in Anypoint Monitoring, see xref:monitoring::anypoint-insights.adoc[].
...
To export the data for any of these charts, click the Export icon (image:export.png["",.]).
...
You can export your analytics data from the charts displayed on your Overview Dashboard or your Custom Dashboard. On either dashboard, click the Export icon (image:export.png["",.]) to download a CSV file with the data for that chart.
