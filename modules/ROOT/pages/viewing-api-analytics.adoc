...
You can view your API Analytics data from both API Manager and Anypoint Monitoring. API Manager and Anypoint Monitoring retain the API Analytics data for up to 30 days.
