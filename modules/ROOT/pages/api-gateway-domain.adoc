...
+
image::api-gateway-new-project.png["Anypoint Studio interface showing API Gateway project creation options"]
...
image::api-gateway-mule-project.png["Mule project configuration showing API Gateway domain association settings"]

By default, a Gateway 2.x domain project is identical to the domain that exists in CloudHub and in your on-premises API Gateway. You must deploy your app to the Anypoint Studio server using the same configuration you deployed the app to production with.  
