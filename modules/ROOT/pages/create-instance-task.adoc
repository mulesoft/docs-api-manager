...
+
include::partial$task-configure-proxy.adoc[tags=arget-type-bullet]

include::partial$task-configure-proxy.adoc[tags=target-type;mid-steps;asset-type-options;last-steps,leveloffset=+2]
