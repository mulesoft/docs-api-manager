...
* **Mule Gateway:** Select Mule Gateway if you have APIs that need an API gateway to manage, observe,
...
.. Select the **Asset type** from the following two options:

** **REST API:** Select REST API if you have an API definition file you want to include for your asset.
+
