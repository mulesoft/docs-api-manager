...
Because every user ID is mapped to the team's client ID, the client ID is propagated with every transaction made by any user ID. With this information, the team manager is able to effortlessly generate analytics for the team.
