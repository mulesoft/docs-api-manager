...
+
image::raml-snippet.png["Policy configuration showing RAML snippet for client ID and secret requirements"]
. Click RAML Snippet.
+
image::snippet-rate-limiting.png["Policy configuration showing RAML snippet for rate limiting implementation"]
