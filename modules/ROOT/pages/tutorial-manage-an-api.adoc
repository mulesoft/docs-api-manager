...
* Click Apply.
+
image::rlp-conditions.png["Resource level policy configuration showing method filters and URI template regex settings"]
+
...
* xref:prepare-raml-task.adoc[Links to RAML snippets]
