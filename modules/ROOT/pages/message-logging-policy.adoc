...
`category` typically indicates the package and class where the logging occurred. The default value is `org.mule`.
`message`: displays the details of the type of issue, for example, `the payload`:
+
