...
+
Under the API Status section, a new link appears labeled *Manage CloduHub proxy*. This links you to the actual application on Runtime Manager for further management, such as changing the worker type and advanced settings.
+
