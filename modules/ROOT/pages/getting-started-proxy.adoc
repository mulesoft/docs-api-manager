...
+
- *Mule version:* If you want to manage the API using Mule 4 or later (recommended), accept the default selection.
+
The parameters that you must specify differ based on the Mule version you select. In this example, create the API for Mule 4.
+
...
* xref:1.x@api-manager::tutorial-set-up-an-api.adoc[Create an API]
