...
image::insert-api.png["API Notebook interface showing Insert API Client button"]
...
image::explore-api.png["API Notebook interface showing API exploration controls"]
