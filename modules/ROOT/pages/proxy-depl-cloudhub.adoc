...
image::redeployproxy.png["API Status section showing green deployment status indicator and Re-deploy Proxy button"]
...
image::proxyhttps-on-two-stages.png["Diagram showing two HTTPS connection points: between client and proxy, and between proxy and API"]
