...
* *API Groups*
+
An API group is an API asset that enables organizations to publish a group of API instances as a single unit. For details, see xref:api-groups-landing-page.adoc[API Groups].
* *Automated Policies* 
+
...
* *Client Applications*
+
Applications are external services that consume APIs. For details, see xref:view-api-contracts.adoc[View API Instance Contracts].
* *Custom Policies*
+
...
An API instance can exist in multiple environments, and you can create multiple instances of an API in one environment.
