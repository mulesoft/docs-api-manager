...
+
Since the API is unprotected, you can now perform management tasks like applying policies, configuring SLA tiers, assigning permissions to the API environment, versioning, viewing API analytics, and more. 
+
...
. Click *Finish*.
. You next pair Studio with the managed API using the Autodiscovery *API ID*. 
+
Select the *Global Elements* tab in your Mule Configuration File editor.
