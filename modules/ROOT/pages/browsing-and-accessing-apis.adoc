...
image::api-manager-client-app.png["Client applications list showing registered applications with their status and management options"]
...
image::api-manager-client-app-controls.png["Client application management interface with controls for access and configuration"]
...
image::developer-portals-list.png["List of available developer portals with search and filtering options"]
...
image::developer-portals-search-by-tag.png["Developer portal search interface with tag-based filtering options"]
