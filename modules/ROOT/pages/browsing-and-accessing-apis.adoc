...
image::api-manager-client-app.png["Client applications list with application names and access status"]
...
image::api-manager-client-app-controls.png["Client application details with access token and credential management"]
...
image::developer-portals-list.png["Developer portals list with API categories and search field"]
...
image::developer-portals-search-by-tag.png["Portal search interface with tag filter dropdown and results list"]
