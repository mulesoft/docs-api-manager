...
image::api-manager-client-app.png["API Manager client applications dashboard showing registered applications and their status"]
...
image::api-manager-client-app-controls.png["Client application management panel with access controls, configuration options, and security settings"]
...
image::developer-portals-list.png["Developer portal dashboard showing available API portals with search, filtering, and navigation options"]
...
image::developer-portals-search-by-tag.png["Developer portal search interface with tag-based filtering and sorting options"]
