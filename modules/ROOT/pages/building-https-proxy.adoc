...
include::partial$task-configure-proxy.adoc[tags=intro,leveloffset=+2]

include::partial$task-configure-proxy.adoc[tags=first-steps,leveloffset=+2]

include::partial$task-configure-proxy.adoc[target-type-heading;target-type-number;target-type,leveloffset=+2]

include::partial$task-configure-proxy.adoc[mid-steps-heading;mid-steps;asset-type-options,leveloffset=+2]

include::partial$task-configure-proxy.adoc[mid-steps2,leveloffset=+2]

include::partial$task-configure-proxy.adoc[tags=last-steps-heading;last-steps,leveloffset=+2]
