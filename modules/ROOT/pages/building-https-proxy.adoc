...
include::partial$task-configure-proxy.adoc[tags=intro]

include::partial$task-configure-proxy.adoc[tags=first-steps,target-type-heading;target-type-number;target-type,leveloffset=+2]
