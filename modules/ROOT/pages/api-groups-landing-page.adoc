...
To perform all tasks pertaining to API groups, the API Group Administrator permissions, which is set at the business group-level is required. An API Group Administrator can create, update, delete all groups in the business group. The permission also gives `View` access to all API instances in the business group to be able to add API instances to the API Group.

The API Group Administrator permission is also required to configured SLA tiers and manager contracts with API Groups.
