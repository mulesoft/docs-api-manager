...
+
include::partial$api-configuration-tables[tags=mule-app-downstream]
+
Deploy a proxy application::::
+
include::partial$api-configuration-tables[tags=mule-proxy-downstream]
. Click *Next*
. Configure the upstream:
+
Connect to existing application (basic endpoint)::::
+
include::partial$api-configuration-tables[tags=mule-app-upstream]
+
Deploy a proxy application::::
+
include::partial$api-configuration-tables[tags=mule-proxy-upstream]
