= Using Classic API Creation Flows
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

If you are running an API with a standalone server, use the following API Instance creation flow.

== Add the API Instance

To add an API instance using the classic API creation flow:
...
. Click **use the classic API creation flows** link at the bottom of the page.
