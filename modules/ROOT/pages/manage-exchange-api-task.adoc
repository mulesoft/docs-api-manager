...
* If you want to enable API specification testing for your API, check *Enable Console* and specify a different path in the *Console Path* field, for example, "/spec/*".
