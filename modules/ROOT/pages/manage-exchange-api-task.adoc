...
+
image::manage-api-expanded.png[width=35%]
+
...
. To secure outbound traffic, in *TLS Context for outbound traffic*, click the ellipses (...) button next the *Add TLS Context* link and enter the details in the *Select TLS Context* window.
