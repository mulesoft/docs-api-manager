...
** `proxy.path = /Proxy /user`, `http://jsonplaceholder.typicode.com/users` is returned. 
** `proxy.path = /users`, `http://jsonplaceholder.typicode.com` is returned. 
** `proxy.path = /users/user`, `http://jsonplaceholder.typicode.com/users` is returned. 
** `proxy.path = /api/users`, `http://jsonplaceholder.typicode.com/users` is returned.
+
