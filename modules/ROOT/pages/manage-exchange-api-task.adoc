...
. If you want to manage the API using Mule 4 or later, select the *Mule version* checkbox and perform the following steps:
...
.. If you want to secure outbound traffic, click the + button next the Add TLS Context
