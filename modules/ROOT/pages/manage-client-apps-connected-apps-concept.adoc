...
This section only demonstrates how to create a client application. For more information about the API Manager API requests to manage client applications, see https://dev-portal.mulesoft.com/apis/api-manager.html[API Manager API Documentation^].
