...
To create a Connected App, see xref:access-management::connected-apps-developers.adoc#create-a-connectedapp[]
...
. Select the root organization for *Business Group* associated with this scope.
