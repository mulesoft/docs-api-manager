...
| *Service Name* | Name of WSDL service | Yes | Only avaliable for WSDL APIs
| *Service Port* | Port for WSDL service | Yes | Only avaliable for WSDL APIs
| *Service Namespace* | Namespace of WSDL service | Yes | Only avaliable for WSDL APIs
