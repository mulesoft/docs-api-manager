...
====
+
NOTE: If you plan to have xref:building-https-proxy.adoc[HTTPS] communications, specify a TLS Context.
...
====
+
.Mule Gateway Existing Application Endpoint (basic endpoint)
[%collapsible]
====
include::partial$endpoint-reference-table.adoc[tags=mule-app-downstream]
====
+
.Mule Gateway proxy application
[%collapsible]
====
include::partial$endpoint-reference-table.adoc[tags=mule-proxy-downstream]
====
