...
As the Organization Administrator of the master organization, you can revoke and delete an application to which you previously gave access to your API. 

Before you delete a contract, you must first revoke it. Deleting a contract deletes any granted access to that contract from Anypoint Exchange.
