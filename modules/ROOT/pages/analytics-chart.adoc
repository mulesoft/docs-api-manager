...
API Analytics provides a summary in chart form of requests, top apps, and latency for 1 hour, 3 hours, 1 day, 7 days, 1 month, 3 months, or 1 year. This data is available for 30 days. To view the Analytics chart, in API Manager, click the instance name of a deployed API.
...
image::analytics-performance.png["A latency summary chart showing an average latency of 2.74k for a one hour duration starting at 8:30 am."]
