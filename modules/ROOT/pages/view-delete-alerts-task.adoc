...
In the Organization Administrators role for the root organization, you can view a list of alerts.
...
+
image::using-api-alerts-ca625.png["API alerts dashboard showing list of configured alerts with their status, conditions, and management options"]
+
. Select an alert in the list.
+
Details about the alert options appear.
+
Click Trash image:trash.png[""].