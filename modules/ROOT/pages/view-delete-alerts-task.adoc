...
If you have been granted the *Organization Administrators* role for the master organization, you can view a list of alerts that are generated for APIs in the API Manager.
