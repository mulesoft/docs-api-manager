...
Only one route per API instance is required. You can add additional routes by clicking *Add Route (optional)*, and you can delete routes by clicking the *Trash Can* icon (image:trashcan-icon.png[2%,2%]). If only one route is defined, you cannot delete that route.
...
You can add upstream by clicking *Add Upstream (optional)*, and you can delete upstreams by clicking the *Trash Can* icon (image:trashcan-icon.png[2%,2%]). If only one upstream is defined, you cannot delete that upstream.
