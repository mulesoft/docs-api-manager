...
In addition to using route rules, Flex Gateway directs requests to different routes using the top to bottom order of how the routes appear on the page.

Flex Gateway directs requests to the first route where the request meets the route rules. 

To define the route order, use the up and down arrows to rearrange the routes.
