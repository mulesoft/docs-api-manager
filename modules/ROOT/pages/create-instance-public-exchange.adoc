= Adding an MCP Server or Agent Instance from Public Exchange
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

This workflow describes how to create an MCP server or agent instance in API Manager by selecting an asset published in the Public Exchange (Provided by MuleSoft).

You can use this workflow when you want to base a new instance on a publicly available asset, such as an MCP server, agent, or API specification published to Exchange and maintained outside your organization.
...
* To create an agent instance, click *Agent*.
