...
* Step 1: First enable xref:access-management::conf-client-mgmt-pf-task.adoc[client management in Access Management]. 
+
You can then configure your client providers in Access Management and implement the client providers and policies in API Manager.
* Step 2: Configure environments and business groups in Access Management.
* Step 3: Create or modify APIs using the new IdPs. 
* Step 4: Configure policies associated to the new IdP.
