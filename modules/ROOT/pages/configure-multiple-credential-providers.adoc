...
* Step 1: To configure multiple external client providers, you must first enable client management in Access Management. You can then configure your client providers in Access Management and implement the client providers and policies in API Manager.
* Step 2: 
* Step 3: 
* Step 4:
...
* xref:access-management::conf-client-mgmt-pf-task.adoc[Configuring Client Management in Access Management]
* 
