...
You can use any web-accessible RAML file or insert an API from the Anypoint API Portal by mousing over the dot between cells and selecting "Insert API."
...
*Never* enter your tokens directly into a notebook. Any one that can access your notebook would have access to your tokens.

Authenticating without supplying credentials will popup a modal where you can safely enter them.
...
That's just a taste of what you can do with the GitHub API and the notebook.

Create your own notebook to explore the GitHub API.
