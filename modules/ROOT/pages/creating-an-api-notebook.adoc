...
image::creating-an-api-notebook-4f42a.png["API Notebook interface with code editor and execution controls",height=129,width=242]
...
image::agent.png["API Notebook interface showing code completion suggestions for API client creation"]
...
. Click the *save* icon.
+
image::notebook2.png["GitHub gist save interface for storing API Notebook"]
+
...
image::notebook3.png["Share dialog with options for URL sharing and embedding API Notebook"]
...
image::play.png["Play button for executing all code cells sequentially in API Notebook"]

== See Also

* xref:samples-api-notebook.adoc[API Notebook examples]
