...
[CAUTION]
--
If you already have all your policies encrypted and then needed to restart the Mule runtime engine without an encryption key, all policies will be downloaded again, and all the sensitive information won't be encrypted.
--
