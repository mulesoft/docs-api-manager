...
This feature is supported in Mule versions 4.2.0 and later.
...
To learn how to configure the agent with encryption, see xref:runtime-manager::installing-and-configuring-runtime-manager-agent.adoc[Install and Configure the Runtime Manager Agent].
