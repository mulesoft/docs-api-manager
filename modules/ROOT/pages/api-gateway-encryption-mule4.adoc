...
--
+
For more information, see mule-runtime::secure-configuration-properties.adoc#secure-properties-tool[Passing Additional Arguments to the JVM to Control Mule].
