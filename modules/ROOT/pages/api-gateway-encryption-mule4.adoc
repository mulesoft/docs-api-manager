...
This feature is supported in Mule 4.2.0 and later. If a policy supporting encryption, such as Basic Authentication 1.2.0 is applied to an API that is running in Mule versions earlier than 4.2.0, the policy is not encrypted.
