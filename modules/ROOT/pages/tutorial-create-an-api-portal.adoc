...
+
image::walkthrough-engage-a4f1a.png["API version details page with API Portal dropdown menu and Create New Portal option",height=218,width=279]
+
...
+
image::walkthrough-engage-a4322.png["Portal creation dialog with options to create a new portal or attach to an existing portal"]
