...
You can enable the PingFederate OAuth 2.0 Token Enforcement policy to use the gateway proxy settings by specify the following property when starting the Mule runtime engine: 
...
*The PingFederate OAuth 2.0 Token Enforcement does not appear in the list of policies to apply to the API.*
