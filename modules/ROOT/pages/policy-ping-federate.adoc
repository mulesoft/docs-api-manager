...
You can enable the PingFederate Access Token Enforcement policy to use the gateway proxy settings by specifying the following property when starting the Mule runtime engine: 
