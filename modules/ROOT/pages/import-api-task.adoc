...
For the import to work successfully, you must copy of the API ZIP file exported from API Manager. You must import the API to the same business group as the one from which you exported in the source location.
