...
image::limits.png["Rate limiting configuration panel with request count and time window settings",height=166,width=761]
...
* xref:rate-limiting-and-throttling.adoc[Throttling And Rate Limiting Reference]
