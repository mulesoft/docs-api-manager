...
// So how does the providedCharacteristic translate for the customer? On what basis can you apply or not apply multiple policies? Not clear
...
| PingFederate Access Token Enforcement | Restricts access to a protected resource using PingFederate authentication server.
