...
+
image::proxying-your-api-65680.png["Deploy Proxy dialog with configuration options for API Gateway Runtime or Mule Runtime instance"]
+
. Click `Click here`.
+
...
+
image::proxying-your-api-b3c5e.png["Runtime Manager interface prompting to register a server for proxy deployment"]
+
