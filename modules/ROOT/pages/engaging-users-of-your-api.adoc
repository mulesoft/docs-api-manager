...
image::engaging-users-of-your-api-91dc3.png["API Portal dropdown menu with Create New Portal option",height=186,width=280]
...
image::walkthrough-engage-5f9be.png["Dialog prompting to create a new portal or attach to an existing portal"]
...
image::add1.png["Content addition menu with options for Pages, API Reference, and API Notebook",height=161,width=225]
...
image::add-page.png["Page creation interface with title input and content type selection"]
...
+
image::engaging-users-of-your-api-cf71a.png["Developer portal interface showing list of API portals with search and sort options"]
+
...
+
image::engaging-users-of-your-api-b2f1c.png["My Applications page showing list of approved applications with management controls"]
+
...
image::universal-themes.png["Theme settings panel with logo upload and color customization options"]

If you apply settings at the root organization level, the theme is used in the portals of all your business groups. If you apply settings at the API Administration level for an individual business group, the theme overrides the theme defined at a higher level and affects only the portals of that business group.
...
image::empty-portal-image.png["Image upload interface with supported format list and size limit warning"]
...
image::linking-image.png["External image URL input with validation and preview section"]
...
Applying settings at the root organization level sets the terms and conditions  for APIs used by all your business groups. You cannot apply terms and conditions within the API Administration page of an individual business group.
