...
* xref:aes-oauth-faq.adoc[Reviewing Mule OAuth Provider concepts]
* xref:building-an-external-oauth-2.0-provider-application.adoc[Building the Mule OAuth 2.0 Provider].
