...
+
image::tutorial-create-an-api-notebook-993e9.png["API Notebook interface showing code editor and execution controls"]
+
. From the bottom of the API Reference on the portal, copy the root RAML URL.
+
image::rootraml.png["RAML specification editor with root level configuration options",height=224,width=797]
...
. Click Share image:share.png[""] to share or embed your Notebook.
