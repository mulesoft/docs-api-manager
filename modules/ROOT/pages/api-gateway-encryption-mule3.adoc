...
To configure the runtime through the agent to use encryption the argument `encryption-key` with the desired key as value. +
The agent then encrypts the client ID and Secret.
