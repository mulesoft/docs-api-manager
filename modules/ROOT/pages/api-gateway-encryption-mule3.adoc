...
Before you use the encryption tool, you must download the encryption tool https://docs.mulesoft.com/downloads/api-manager/2.x/gateway-encryption-tool-1.0.0.jar[jar] file. 
