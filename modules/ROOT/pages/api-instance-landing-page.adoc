...
. xref:create-instance-task.adoc[Add an API Instance] - API instances are managed by Anypoint Platform after they are added and remain under management until they are deleted. 
