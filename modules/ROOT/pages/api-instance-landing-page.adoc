...
. xref:create-instance-task.adoc[Add an API Instance] - API instances are managed by Anypoint Platform after you add them and remain under management until you delete them. 
