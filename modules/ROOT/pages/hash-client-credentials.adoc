...
// @Philip Garett--What do we mean by "a consecutive number"?
// Consecutive to what beginning number?
// Does the numbering begin with 1 and then increase by 1 for each consecutive n instance?
// Clarify.
