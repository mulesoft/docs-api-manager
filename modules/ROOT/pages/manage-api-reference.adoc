...
image::index-aad67.png["API Administration page showing list of APIs with version details and management controls",height=315,width=619]
...
image::index-4908b.png["API version details page showing status, policies, and configuration options",height=434,width=711]
...
image::walkthrough-manage-0994c.png["Policy management interface showing available policies with descriptions and configuration options",height=453,width=800]
