...
To create a new API using API Manager, click Add New API from the API Administration page. Enter a name and version identifier (required). The API and version names cannot exceed 42 characters in length. In the main organization, the conjunction of the API name and version must be unique. If you use business groups, the name must be unique within all your business groups and the main organization.
