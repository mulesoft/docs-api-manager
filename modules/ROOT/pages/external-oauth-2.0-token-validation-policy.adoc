...
This policy was designed to be used exclusively with xref:mule-oauth-provider-landing-page.adoc[Mule OAuth provider]. Using the policy with any other OAuth 2.0 provider (for example, Facebook, Google, or Microsoft Azure) is not supported.
