...
image::users-api-cropped.png["API Console interface displaying resources and methods with their associated policies",height=329,width=732]
...
image::rlp-conditions.png["Resource level policy configuration interface with condition settings and method selection"]
