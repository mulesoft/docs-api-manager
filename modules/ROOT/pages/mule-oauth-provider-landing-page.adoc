...
To run the Mule OAuth 2.0 Provider you have to deploy the provider to a runtime with API Gateway capabilities (eg Mule runtime engine v3.x, Mule runtime engine v4.2.0 or later) with the corresponding organization credentials correctly specified.
