...
TIP: The mechanism that caches the result of a successful token validation, is part of the xref:external-oauth-2.0-token-validation-policy.adoc[Mule OAuth 2.0 access token enforcement policy].

=== Customizing Client Application Cache mechanism
