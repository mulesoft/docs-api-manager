...
. From the left menu in *API Manager*, click *DataGraph Administration*.
...
. In the *# of Reqs* field, add the number of requests that are allowed, for example, `100`.
