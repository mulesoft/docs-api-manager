...
. Click *Add group instance* for the version of the API Group you want to add the API instance to.
+
The *Creating a new group instance* page is displayed.
. Click *+Add*.
. If the API instance and the API Group belong to the same business group or organization, select the API, API version, environment, and API version/instance that you want to add to the API Group.
...
. Click the checkbox to acknowledge you understand *this action can't be undone* and click *Delete Group instance*.
