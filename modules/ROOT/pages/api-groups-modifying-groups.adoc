...
* Add only those API instances that belong to the same identity provider (IdP) as the API Group instance. You cannot mix IdPs in an API Group instance.
...
<3> API Group
<4> Add a new version of the API Group
<5> Add a new instance of the API Group version
