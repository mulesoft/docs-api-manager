...
Credentials consist of two keys: the client ID (also referred to as _username_) and a client secret (also referred to as _password_). Anypoint API Manager (API Manager) uses credentials in several different ways. This document presents an overview of the following:
