...
Credentials consist of two keys: the client ID and the client secret. Anypoint API Manager (API Manager) uses credentials in several different ways. This document presents an overview of the following:
