...
This value ensures that your API proxy uses a proxy version `2.0` and later.
+
`2.0` is the recommended version for OAS/RAML specs, since native OAS is only supported by this version. +
