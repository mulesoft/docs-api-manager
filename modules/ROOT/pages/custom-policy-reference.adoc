...
image::basic-flow.png["Policy execution sequence showing before and after processing points in an API request flow"]
...
* xref:3.9@mule-runtime::elements-in-a-mule-flow.adoc[Elements for defining the configuration of a custom policy]
