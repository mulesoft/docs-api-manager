...
In your network, you may need to allowlist the hostnames and ports of various parts of Anypoint Platform to allow API Gateway capabilities of the runtime to communicate with the MuleSoft-managed online Anypoint Platform APIs and services.
...
* xref:runtime-manager::rtm-agent-whitelists.adoc[Ports, IP Addresses, and Hostnames to Allowlist]
