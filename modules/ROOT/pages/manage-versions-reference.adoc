...
image::managing-api-versions-b1e81.png["API Administration page showing expanded list of API versions with version details"]
...
image::import-archive-or-version2017.png["API Administration page showing Add Version dropdown menu with Import option"]
