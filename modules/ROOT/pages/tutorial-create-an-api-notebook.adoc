...
+
image::create-api-client.png["API client creation interface with endpoint selection and configuration options"]
+
...
* Select Execute.
+
image::execute.png["Code execution controls with run button and output display area"]
+
