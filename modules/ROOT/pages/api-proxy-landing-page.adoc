...
* If you already have a Mule application, which is closed-code, and don’t have access to include an xref:configure-autodiscovery-4-task[Autodiscovery] for it. 
