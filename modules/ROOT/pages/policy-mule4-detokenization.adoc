...
The policy reads a token the payload with the tokenized values. To define which pieces of payload will be detokenized, you need to provide Dataweave 2.0 expressions.
