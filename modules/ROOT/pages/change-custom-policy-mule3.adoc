...
In API Manager, you can change the version of your custom policies for your Mule 3 applications without having to remove your current policies and leaving your API instance insecure.
