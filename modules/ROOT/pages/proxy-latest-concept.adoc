...
include::partial$task-configure-proxy.adoc[tags=intro;first-steps;target-type;mid-steps;asset-type-options;mid-steps2;raml-oas-version;last-steps,leveloffset=+2]
