...
The Header Injection policy adds headers to the request or response of the message. When you configure this policy for your API, you must specify an inbound and outbound map of the headers that you want to add in the message processing in the form of a key-value pair. 
