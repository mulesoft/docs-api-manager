...
:page-aliases: regenerate-jar-task.adoc
...
+
image::api-version-details.png["API version management interface showing version details, deployment status, and configuration options"]
+
