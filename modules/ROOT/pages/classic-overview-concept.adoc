...
image::anypoint-platform-for-apis-walkthrough-01761.png["Workflow diagram showing API lifecycle stages with color-coded tasks for administration and development"]
...
image::index-6addf.png["API deployment workflow showing server environments and portal publishing process"]
