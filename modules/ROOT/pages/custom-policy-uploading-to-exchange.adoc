...
For more information about the Exchange asset, seehttps://anypoint.mulesoft.com/exchange/portals/anypoint-platform/f1e97bc6-315a-4490-82a7-23abe036327a.anypoint-platform/exchange-maven-facade-api-http/[Maven facade API].

== Prerequisites

To upload a custom policy to Exchange, you must have the Organization Administrators role.
