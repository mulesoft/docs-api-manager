...
You must configure your Exchange credentials. See below; per best-practices, the password entry should be encrypted. It is shown in plaintext here for clarity. See https://maven.apache.org/guides/mini/guide-encryption.html for instructions.
...
--
. Set up your Exchange credentials in the `settings.xml` file in your Maven `.m2` directory - see comment above about encryption of Maven credentials:
+
[source,XML,linenums]
--
<settings xmlns="http://maven.apache.org/SETTINGS/1.0.0"
