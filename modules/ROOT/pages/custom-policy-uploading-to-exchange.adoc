...
If you created your custom policy project using the provided Maven archetype, the plugins necessary to upload the policy to Exchange are already defined for you. +
...
--
+
* Set up your Exchange server as distribution management:
+
[source,XML,linenums]
--
