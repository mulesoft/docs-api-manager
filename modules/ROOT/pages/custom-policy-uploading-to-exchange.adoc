...
----
+ 
NOTE: For information on how to authenticate using a token rather than through credentials, see xref:exchange::to-publish-assets-maven#publish-and-consume-federated-assets.adoc[Publish and Consume Federated Assets].
...
If you did not create your custom policy project using the provided Maven archetypes, you need to manually set up your Exchange deployment configurations.
