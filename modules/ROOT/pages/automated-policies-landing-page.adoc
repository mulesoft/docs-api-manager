...
* Automated policies are  available for Mule 4 APIs only using the MuleSoft-hosted control plane.
* They support all runtime deployment targets(CloudHub, Anypoint Runtime Fabric, and Hybrid).
