...
If the validation endpoint server is using a self-signed certificate, the certificate needs to be previously installed in the Java JDK of the instance where the policy is deployed.
