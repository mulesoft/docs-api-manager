...
. Use the Scope Validation Criteria field to determine if all or just one of the scopes defined in the previous field must be present on the response from the Identity Provider.
+
