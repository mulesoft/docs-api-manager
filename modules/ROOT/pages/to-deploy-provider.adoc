...
----
+
image::building-an-external-oauth-2_0-provider-application-df5f1.png["OAuth 2.0 provider application configuration interface with authentication settings"]
+
...
xref:to-test-remote-provider.adoc[Test the remote provider].