...
. From Anypoint Studio, add a xref:4.3@mule-runtime::tls-configuration.adoc#use-anypoint-studio-to-configure-tls[keystore (SSL certificate)] to your API proxy (API gateway).
