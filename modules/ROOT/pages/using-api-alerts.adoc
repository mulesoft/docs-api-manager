...
Note: `API Alerts are sent from email address "no-reply@mulesoft.com". This from email address cannot be customized`
...
Note: `Contracts Alerts are sent from email address "no-reply@mulesoft.com". This from email address cannot be customized`
