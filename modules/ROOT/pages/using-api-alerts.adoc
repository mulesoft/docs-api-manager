...
|=======================
|Action |Recipient |Description
|Deployment of an API that is not covered by automated policies |Organization administrators, environment administrators |User will be notified if the API is not mule4 or above.
|=======================
