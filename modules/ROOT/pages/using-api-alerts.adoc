...
Alerts for Flex Gateway differ from API alerts and contract alerts. For example, Flex Gateway includes *Alert Logic* options and the ability
to customize the subject and message of *Email notifications*. See xref:gateway::flex-use-api-alerts.adoc[Using Flex Gateway API Alerts]
