...
You manage Anypoint DataGraph in API Manager. The Anypoint DataGraph Administration tab for a particular environment appears only after you have added at least one API schema to that environment's unified schema.
