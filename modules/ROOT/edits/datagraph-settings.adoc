...
<1> *DataGraph external client providers* control. To see a list of external client providers, previously configured by your organization administrators, click the control. Select a provider from the list. To run queries in Anypoint DataGraph, you'll need the proper credentials from the external client provider.
+
